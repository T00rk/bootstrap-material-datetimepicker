   ...
   Plugin.prototype =
           {
              ...
              initTemplate: function ()
              {
                  ...
                  var yearHtml =
                      ...
                      '<div><a href="javascript:void(0);" class="btn btn-sm btn-secondary dtp-select-year-range before" style="margin: 0;"><i class="material-icons">keyboard_arrow_up</i></a></div>' +
                      yearPicker +
                      '<div><a href="javascript:void(0);" class="btn btn-sm btn-secondary dtp-select-year-range after" style="margin: 0;"><i class="material-icons">keyboard_arrow_down</i></a></div>' +
                      '</div>';
